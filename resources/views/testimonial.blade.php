            ...
            <div class="col-lg-8">
                <div class="bg-white rounded p-5 m-5 mb-0">
                    ...
                    @endif
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <input type="text" class="form-control bg-light border-0" value="{{$userinfo->name}}" name="name"  placeholder="Your Name" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input type="email" class="form-control bg-light border-0" value="{{$userinfo->email}}" name="email"  placeholder="Your Email" style="height: 55px;">
                            </div>
                            <div class="col-12">
